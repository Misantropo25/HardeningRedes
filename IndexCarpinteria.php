...
<head>
    <meta charset="UTF-8">
    <title> Portal de carpinteria.amauta.edu.pe</title>
...
<body>
    <div id="general">
        <div id="header1">
            <header id="cabecera">
                <h1> Bienvenidos a carpinteria.amauta.edu.pe </h1>
            </header>
        </div>
            ...
            <table id="tabla-alumnos">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT CodAlumno, ApPaterno, Nombre, Carrera, Promedio FROM tAlumnos WHERE Carrera = 'carpinteria'";
